import { an as NOOP_MIDDLEWARE_HEADER, ao as REDIRECT_STATUS_CODES, A as AstroError, ap as ActionsReturnedInvalidDataError, aq as escape, W as DEFAULT_404_COMPONENT } from './astro/server_DWmbGqKx.mjs';
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { CI: 1 })?.DEV) {
...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__, { CI: 1 })?.PROD) {
